...
<template>
  <div v-on="{ click: onReadMessage }" :class="`flex px-5 py-3 items-center gap-5 rounded cursor-pointer ${read ? 'bg-gray-50 hover:bg-gray-50/80' : priority == 'high' ? 'bg-red-100 hover:bg-red-100/80' : 'bg-blue-100 hover:bg-blue-100/80'}`">
    <div>
