...
<template>
  <header class="relative">
    ...
    <ScreechScreen />
    <h1
      class="absolute right-[14px] top-[100px] w-[135px] text-lg font-bold text-white text-center"
    >
      You have {{ unreadMessageCount > 0 ? unreadMessageCount : 'no' }} new message{{
        unreadMessageCount > 1 || unreadMessageCount === 0 ? 's' : ''
      }}!
    </h1>
